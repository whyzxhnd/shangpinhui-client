            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  :key="AttrValue.id"
                  @click="
                    changeActive(AttrValue, spuSaleAttr.spuSaleAttrValueList)
                  "
                >
...
export default {
  ...
  methods: {
    ...
    changeSkuNum(e) {
      let value = e.target.value * 1; // 当输入的不是数字时,value为NAN
    ...
    // 点击加入购物车
    async addShopcart() {
      // console.log(this.skuNum); // 下面的返回值是一个promise对象
      // 使用try catch
      try {
