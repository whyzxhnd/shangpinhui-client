  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="changeSelected(address, addressInfo)">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img style="width: 82px; height: 82px" :src="order.imgUrl" alt="" />
          </li>
          <li>
            <p>
              {{ order.skuName }}
          ...
          <li>
            <h3>￥{{ order.orderPrice && order.orderPrice.toFixed(2) }}</h3>
          </li>
...
export default {
    ...
    userDefaultAddress() {
      return (
        this.addressInfo.find((item) => {
          return item.isDefault == 1; // 返回满足条件的对象
        }) || {}
      );
    },
    //
  ...
  methods: {
    // 改变地址
    changeSelected(address, addressInfo) {
